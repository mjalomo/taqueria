...
/**
 * Base class that represents a row from the 'combo' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Combo implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ComboTableMap';
    ...
    /**
     * Initializes internal state of Base\Combo object.
     */
    ...
    /**
     * Compares this with another <code>Combo</code> instance.  If
     * <code>obj</code> is an instance of <code>Combo</code>, delegates to
     * <code>equals(Combo)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Combo The current object, for fluid interface
     */
     ...
     * @return $this|\Combo The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ComboTableMap::COL_ID] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[ComboTableMap::COL_PRICE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ComboTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ComboTableMap::translateFieldName('Price', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = ComboTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Combo'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildComboQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildComboQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ComboTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ComboTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ComboTableMap::COL_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'price';
        }

        $sql = sprintf(
            'INSERT INTO combo (%s) VALUES (%s)',
    ...
    {
        $pos = ComboTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Combo'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Combo'][$this->hashCode()] = true;
        $keys = ComboTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ComboTableMap::COL_ID)) {
            $criteria->add(ComboTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ComboTableMap::COL_PRICE)) {
            $criteria->add(ComboTableMap::COL_PRICE, $this->price);
        }
    ...
    {
        $criteria = ChildComboQuery::create();
        $criteria->add(ComboTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Combo (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Combo Clone of current object.
     * @throws PropelException
     */
    ...
    public function setComboFoods(Collection $comboFoods, ConnectionInterface $con = null)
    {
        ...
        foreach ($comboFoodsToDelete as $comboFoodRemoved) {
            $comboFoodRemoved->setCombo(null);
        }
     ...
     * Otherwise if this Combo is new, it will return
     * an empty collection; or if this Combo has previously
     * been saved, it will retrieve related ComboFoods from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Combo.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildComboFood[] List of ChildComboFood objects
     */
    public function getComboFoodsJoinFood(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildComboFoodQuery::create(null, $criteria);
    ...
    public function setComboRequests(Collection $comboRequests, ConnectionInterface $con = null)
    {
        ...
        foreach ($comboRequestsToDelete as $comboRequestRemoved) {
            $comboRequestRemoved->setCombo(null);
        }
     ...
     * @return ObjectCollection|ChildComboRequest[] List of ChildComboRequest objects
     */
    public function getComboRequestsJoinRequest(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildComboRequestQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(ComboTableMap::DEFAULT_STRING_FORMAT);
    }

...
class FoodTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.FoodTableMap';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_CAMELNAME     => array('id', 'name', 'price', ),
        self::TYPE_COLNAME       => array(FoodTableMap::COL_ID, FoodTableMap::COL_NAME, FoodTableMap::COL_PRICE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'price' => 2, ),
        self::TYPE_COLNAME       => array(FoodTableMap::COL_ID => 0, FoodTableMap::COL_NAME => 1, FoodTableMap::COL_PRICE => 2, ),
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(FoodTableMap::COL_PRICE);
        } else {
